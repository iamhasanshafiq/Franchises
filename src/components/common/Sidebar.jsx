  ...
  return (
    <motion.aside
      ...
      className={cn(
        ...
        'bg-slate-100/95 dark:bg-slate-950/95 backdrop-blur-2xl',
        'border-r border-white/20 dark:border-slate-800/80',
    ...
    >
      ...
      <div
        className={cn(
          'relative flex items-center h-24 shrink-0 border-b border-slate-200/60 dark:border-slate-800/60',
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span className="block font-black text-slate-900 dark:text-white leading-none tracking-tight whitespace-nowrap">
                BARQI OPS
              </span>
              ...
              <div className="flex items-center gap-1.5 mt-1.5">
                ...
                <span className="text-[10px] font-black text-emerald-600 uppercase tracking-[0.2em] whitespace-nowrap">
                  Command Node
                </span>
              </div>
            </motion.div>
      ...
      <nav className="flex-1 px-4 py-4 space-y-1.5 overflow-y-auto overflow-x-hidden custom-scrollbar">
        {!collapsed && (
          <p className="px-4 mb-3 text-[10px] font-black text-slate-400 uppercase tracking-[0.25em]">
            Operations Menu
          </p>
        )}
              ...
              <Icon
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : 'group-hover:scale-[1.08] group-hover:text-orange-500'
                )}
              />
