      ...
      <div className="p-8 max-w-7xl mx-auto space-y-6">
        <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
            ...
            <Button onClick={handleOpenModal} disabled={loading} className="rounded-xl h-11 px-6 shadow-xl shadow-emerald-100 transition-all hover:scale-105 active:scale-95 bg-emerald-600 hover:bg-emerald-700">
          ...
          <div className="p-4 border-t border-slate-50 bg-slate-50/30 text-center">
            {loading ? (
              <div className="h-4 w-40 bg-muted rounded animate-pulse mx-auto"></div>
            ) : (
